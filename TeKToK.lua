...
Delete_Message(msg.chat_id_,lk_zain)
...
elseif text and (text == "تنظيف جميع الميديا" or text == "تنظيف الميديا") and Admin(msg) then   
    ...
    tdcli_function({ID = "GetMessages",chat_id_ = msg.chat_id_,message_ids_ = lk_zain},function(arg,data)
        new = 0
        lk_zain2 = {}
        for i=0 ,data.total_count_ do
            if data.messages_[i] and data.messages_[i].content_ and data.messages_[i].content_.ID ~= "MessageText" then
                lk_zain2[new] = data.messages_[i].id_
                new = new + 1
            end
        end
        Delete_Message(msg.chat_id_,lk_zain2)
    end,nil)  
...
if (data.message_.content_.text_) then 
    if (ban_zain["ban"..msg.chat_id_..msg.sender_user_id_] and ban_zain["ban"..msg.chat_id_..msg.sender_user_id_] == data.message_.content_.text_ and ban_zain["ban:count:"..msg.chat_id_..msg.sender_user_id_] and ban_zain["ban:count:"..msg.chat_id_..msg.sender_user_id_] >= 3) then 
        if (ban_zain["ban2:"..msg.chat_id_..msg.sender_user_id_]) then 
            ban_zain["ban2:"..msg.chat_id_..msg.sender_user_id_] = nil
--             send(msg.chat_id_, msg.id_,"⌔︙لتلح يا حلو 😉")  
        end 
        return false
    elseif(ban_zain["ban"..msg.chat_id_..msg.sender_user_id_] and ban_zain["ban"..msg.chat_id_..msg.sender_user_id_] == data.message_.content_.text_ and ban_zain["ban:count:"..msg.chat_id_..msg.sender_user_id_]) then 
        ban_zain["ban:count:"..msg.chat_id_..msg.sender_user_id_] = ban_zain["ban:count:"..msg.chat_id_..msg.sender_user_id_] + 1;
    elseif(ban_zain["ban"..msg.chat_id_..msg.sender_user_id_] and ban_zain["ban"..msg.chat_id_..msg.sender_user_id_] == data.message_.content_.text_) then 
        ban_zain["ban:count:"..msg.chat_id_..msg.sender_user_id_] = 1;
    else 
        ban_zain["ban"..msg.chat_id_..msg.sender_user_id_] = data.message_.content_.text_
        ban_zain["ban2:"..msg.chat_id_..msg.sender_user_id_] = true
        ban_zain["ban:count:"..msg.chat_id_..msg.sender_user_id_] = 1;
    end 
