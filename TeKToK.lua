...
function Dev_tektok_User(user)  -- المطور الاساسي 
...
function DeveloperBot(msg)  -- مطور البوت 
...
function PresidentGroup(msg) -- المالك
...
function BasicBuilder(msg) -- المنشئ الاساسي 
local hash = redis:sismember(bot_id.."Basic:Builder"..msg.chat_id_, msg.sender_user_id_) 
...
function AddChannel(User) -- Zain AL abdeen 
local url , res = https.request('https://contentss.me/kid/ch.php/?id='..User..'') --- Developer :- @LGlobla 
...
Status = true
elseif redis:sismember(bot_id.."Basic:Builder"..chat_id, user_id) then
Status = true
...
elseif redis:sismember(bot_id.."President:Group"..chat_id, user_id) then
Status = redis:get(bot_id.."President:Group:Reply"..chat_id) or redis:get(bot_id.."Add:Validity:Users"..chat_id..user_id) or "المالك"
elseif redis:sismember(bot_id.."Basic:Builder"..chat_id, user_id) then
Status = redis:get(bot_id.."Basic:Builder:Reply"..chat_id) or redis:get(bot_id.."Add:Validity:Users"..chat_id..user_id) or "المنشئ الاساسي"
elseif redis:sismember(bot_id..'Constructor:Group'..chat_id, user_id) then
...
url = 'https://raw.githubusercontent.com/TekTokTeam/TeKToK/master/Script.lua'
...
if Info_Group.President then
for k,Id_President in pairs(Info_Group.President) do
redis:sadd(bot_id.."Basic:Builder"..Id_Group,Id_President)
end
end
...
if Info_Group.Status_Prt then
if Info_Group.Status_Prt ~= "" then
redis:set(bot_id.."Basic:Builder:Reply"..Id_Group,Info_Group.Status_Prt)   
end
end
...
if redis:sismember(bot_id.."Basic:Builder", msg.sender_user_id_) then  
Constructor = true  
end 
...
if redis:sismember(bot_id.."Basic:Builder"..msg.chat_id_, msg.sender_user_id_) then  
Owner = true  
end
...
download_to_file('https://raw.githubusercontent.com/TekTokTeam/TeKToK/master/Script.lua','Script.lua') 
...
local BasicBuilder = redis:smembers(bot_id.."Basic:Builder"..v)
...
local Status_Prx = redis:get(bot_id.."Basic:Builder:Reply"..v) 
...
redis:del(bot_id.."Basic:Builder"..msg.chat_id_)
...
local list = redis:smembers(bot_id.."Basic:Builder"..msg.chat_id_)
...
function FunctionStatus(arg, result)
redis:sadd(bot_id.."Basic:Builder"..msg.chat_id_, result.sender_user_id_)
...
function FunctionStatus(arg, result)
redis:srem(bot_id.."Basic:Builder"..msg.chat_id_, result.sender_user_id_)
...
redis:sadd(bot_id.."Basic:Builder"..msg.chat_id_, result.id_)
...
function FunctionStatus(arg, result)
if (result.id_) then
redis:srem(bot_id.."Basic:Builder"..msg.chat_id_, result.id_)
...
redis:sadd(bot_id.."Basic:Builder"..msg.chat_id_, text:match("^رفع منشئ اساسي (%d+)$") )
...
redis:srem(bot_id.."Basic:Builder"..msg.chat_id_, text:match("^تنزيل منشئ اساسي (%d+)$") )
...
redis:set(bot_id.."Basic:Builder:Reply"..msg.chat_id_,Teext)
...
redis:del(bot_id.."Basic:Builder:Reply"..msg.chat_id_)
...
mal = "⌔︙( المالك ... ✓️) \n" else mal = "" end
if redis:sismember(bot_id.."Basic:Builder"..msg.chat_id_, result.id_) then
...
redis:srem(bot_id.."President:Group"..msg.chat_id_,result.id_)
redis:srem(bot_id.."Basic:Builder"..msg.chat_id_,result.id_)
elseif redis:sismember(bot_id.."Basic:Builder"..msg.chat_id_, msg.sender_user_id_) then
redis:srem(bot_id..'Admin:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'Vip:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'Manager:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'Constructor:Group'..msg.chat_id_, result.id_)
...
if redis:sismember(bot_id.."President:Group"..msg.chat_id_, result.id_) then
mal = "⌔︙( المالك ... ✓️) \n" else mal = "" end
if redis:sismember(bot_id.."Basic:Builder"..msg.chat_id_, result.sender_user_id_) then
crr = "⌔︙( المنشئ الاساسي ... ✓️) \n" else crr = "" end
