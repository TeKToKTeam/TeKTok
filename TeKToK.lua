...
download_to_file('https://raw.githubusercontent.com/TekTok/TeKToK/master/TeKToK.lua','TeKToK.lua') 
download_to_file('https://raw.githubusercontent.com/TekTok/TeKToK/master/Script.lua','Script.lua') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/TekTok/Files_TeKToK/master/getfile.json")
if res == 200 then
...
local Get_Json, Res = https.request("https://raw.githubusercontent.com/TekTok/Files_TeKToK/master/Files_TeKToK/"..File_Name)
if Res == 200 then
